...
ROUND(1.0 * guest.sup_stats.sup_mun_cntr_num / guest.sup_stats.sup_cntr_num, 3) AS 'sup_nun_cntr_share',
...
ROUND(1.0 * guest.org_stats.org_mun_cntr_num / guest.org_stats.org_cntr_num, 3) AS 'org_nun_cntr_share',
